...
class CouponConfiguration extends AbstractModel
{
     ...
     * code must be unique across eBay. <br><br>The code must be from 8-15 alphanumeric
     * characters and can contain no more than two dashes ( - ).<br><br>This is
     * required when the promotion type is CODED_COUPON.
     *
     * @var string
     */
     ...
     * promotion type is <b>CODED_COUPON</b>.<br><br>Supported
     * types:<ul><li><b>PRIVATE_SINGLE_SELLER_COUPON:</b> Anyone can use and share the
     * coupon code, but it isn't posted on
     * eBay.</li><li><b>PUBLIC_SINGLE_SELLER_COUPON:</b> Anyone can find the coupon
     * code on eBay and use it.</li></ul> For implementation help, refer to <a
